  ...
  <div class="kanban">
    ...
    >
      ...
      <div class="column-body">
        <div v-for="(task, task_index) in column.task" :key="task_index">
          <div
            class="task"
            :draggable="true"
...
.column {
  ...
  margin: 25px;
  -webkit-box-shadow: 10px 24px 35px 8px rgba(31, 15, 31, 1);
  -moz-box-shadow: 10px 24px 35px 8px rgba(31, 15, 31, 1);
  box-shadow: 10px 24px 35px 8px rgba(31, 15, 31, 1);
  padding: 10px;
}
.column-header {
  display: flex;
